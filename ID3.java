...
public class ID3 extends Classifier implements TechnicalInformationHandler, Sourcable
{
	...
	private void makeTree(Instances data) throws Exception
	{
		...
		// Compute attribute with maximum gain ratio (gain ratio = info gain / split gain)
		double[] infoGains = new double[data.numAttributes()];
		double[] splitInfo = new double[data.numAttributes()];
		...
		while (attEnum.hasMoreElements())
		{
			...
			splitInfo[att.index()] = computeSplitInfo(data, att);
			gainRatio[att.index()] = infoGains[att.index()] / splitInfo[att.index()];
		}
	 ...
	 * @param att the attribute
	 * @return the split info for the given attribute and data
	 * @throws Exception
	 */
	private double computeSplitInfo(Instances data, Attribute att) throws Exception
	{
		...
		{
			double ratio = (double)splitData[i].numInstances() / totalInstances;
